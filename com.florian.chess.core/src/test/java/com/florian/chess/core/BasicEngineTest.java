...
public class BasicEngineTest {
	...
	private static BasicEngine engine;
	...
	public void getBestMove_CanWinQueenForRookAndBishop_FindsTheBestMove() {
		engine.setPosition("4rrk1/pp1q2bn/3p2p1/2pP1p2/PnP4B/2NB1Q1P/1P4P1/R4RK1 b - - 0 1");
	...
	public void getBestMove_CanWinTheQueenForARook_FindsTheBestMoves() {
		engine.setPosition("6k1/ppr1r1b1/4pBQ1/4P2p/7P/2P2R2/P4PPK/3q4 w - - 0 1");
	...
	public void getBestMove_CanWinTheQueenForABishop_FindsTheBestMove() {
		engine.setPosition("rnb1kb1r/ppp2ppp/2qp4/3N4/4PQn1/8/PPP2PPP/R1B1KBNR w KQkq - 0 1");
	...
	public void getBestMove_VeryLongCombination_FindsTheBestMove() {
		engine.setPosition("4r1k1/1pb3pp/p1p2p2/6r1/1P1PP2n/P6q/2Q2RP1/2B1RNK1 b - - 0 1");
	...
	public void getBestMove_CanWinQueenForRookAndKnight_FindsTheBestMove() {
		engine.setPosition("2r5/q4kp1/3Rp1Np/3b1p1P/8/4P3/1Q3PP1/6K1 w - - 0 1");
	...
	public void getBestMove_CanWinARook_FindsTheBestMove() {
		engine.setPosition("4/r2k/pR5p/6p1/4b3/3B4/2P2K2/1P6/8 w - - 0 1");
	...
	public void getBestMove_CanWinARookWithAQueenCheck_FindsTheBestMove() {
		engine.setPosition("4r1k1/3R1ppp/5q2/8/3QP3/2p2P2/6PP/6K1 b - - 0 1");
	...
	public void getBestMove_SpectacularQueenSacrificeWinsARook_FindsTheBestMove() {
		engine.setPosition("1rb2bk1/p5pp/1nn1p3/q2pP1B1/2pP2B1/1pP3P1/PP1Q3P/RN3NK1 b - - 0 1");
	...
	public void getBestMove_CanWinTheQueenForABishopAndARookWithASpeer_FindsTheBestMove() {
		engine.setPosition("3r2k1/pRp2p2/6pQ/5b2/2B5/2qP2P1/P6P6K1 w - - 0 1");
	...
	public void getBestMove_CanWinTheQueenForARookWithASpear_FindsTheBestMove() {
		engine.setPosition("1r4k1/6p1/4O2p/2p2p2/P3q3/4P3/2R2P1P/2Q2K2 b - - 0 1");
	...
	public void getBestMove_CanWinABishopWithASpectacularQueenSacrifice_FindsTheBestMove() {
		engine.setPosition("B1b5/2q5/p2kp3/4b1Q1/8/4B1P1/PPP4P/6K1 w - - 0 1");
		engine.setDepth(6);
	...
	public void getBestMove_CanWinTheQueenForTwoKnights_FindsTheBestMove() {
		engine.setPosition("r2qr1k1/bpp2pp1/p5np/7N/4Np2/1bPP1Q1P/PP3PP1/R3R1K1 w - - 0 1");
		engine.setDepth(6);
	...
	public void getBestMove_CanForkTwoRooks_FindsTheBestMove() {
		engine.setPosition("5rk1/r4qb1/3p2n1/2pN2P1/4P1QP/1P6/P2R1PK1/4R3 b - - 0 1");
		engine.setDepth(6);
	...
	public void getBestMove_CanForkBishopAndRook_FindsTheBestMove() {
		engine.setPosition("1rr3k1/4Bpbp/3p2p1/8/q1p5/P5P1/1P1QPP1P/1RR3K1 b - - 0 1");
		engine.setDepth(6);
	...
	public void getBestMove_CanWinQueenForRookAndKnightWithAFork_FindsTheBestMove() {
		engine.setPosition("4rrn1/3qp2p/p1p1R1pk/8/8/2Q2N1P/PP3PP1/4R1K1 w - - 0 1");
	...
	public void getBestMove_NastyQueenForksAround_FindsTheBestMove() {
		engine.setPosition("r4rk1/pp2ppbp/5n2/2p4q/P4B1N/6QP/1PP3P1/3R1RK1 w - - 0 1");
		engine.setDepth(6);
	...
	public void getBestMove_WhenThePositionIsSetWithAFenString_ReturnsSomeLegalMove() {
		engine.setPosition("8/1R5k/4bP1p/4N1p1/3pr3/1P6/3K4/8 b - - 1 54");
		engine.setDepth(6);
		engine.findBestMove();
		Move move = engine.getBestMove();
