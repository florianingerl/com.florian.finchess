...
import com.florian.chess.core.Move;
import com.florian.chess.core.MoveEncoding;
import com.florian.chess.core.Position;
import com.florian.chess.core.VariationNode;
import com.florian.chess.core.VariationTree;
...
public class ReadPGNHeadersTest {
	...
	public void getListOfGames_OfKramnikVsSanan_ReturnsOnlyOneGame() {
		...
		try {
			ReadPGNHeaders rpn = new ReadPGNHeaders(getClass().getClassLoader()
					.getResourceAsStream("portals_3_files_2014_kataropen_kramniksjugirov.pgn"));
			rpn.parseHeaders();
	...
	public void getListOfGames_OfAlkhines2Nc3d5Games_ReturnsALotOfGames() {
		{
			try {
				ReadPGNHeaders rpn = new ReadPGNHeaders(
						getClass().getClassLoader().getResourceAsStream("Alekhine2Nc3-d5.pgn"));
				rpn.parseHeaders();
				List<PgnGame> games = rpn.getListOfGames();
